 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Jesse Huang");
		  toPrint += p1.toString("jhuang347");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Paul Kim");
		  toPrint += p2.toString("pkim49");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Nathania Nah");
		  toPrint += p3.toString("nnah3");
      //Person4 replace P4 with your name
      //and gburdell4 with your gt id
      Person4 p4 = new Person4("Nathan Whitley");
      toPrint += p4.toString("nwhitley3");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Eugenia Kim");
          toPrint += p5.toString("ekim317");
		  Person6 p6 = new Person6("Timothy Lai");
          toPrint += p6.toString("tlai37");
